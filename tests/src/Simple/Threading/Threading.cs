...
internal static class Runner
{
    ...
    {
        Console.WriteLine("    WaitSubsystemTests.Test");
        WaitSubsystemTests.Test();
...
internal static class WaitSubsystemTests
{
    ...
    public class Approximate
    {
        ...
        {
            Console.WriteLine("MultiplyAv Begin");
            for (int i = range_begin; i < range_end; i++)
            {
                double sum = 0;
            ...
            Console.WriteLine("MultiplyAv End");
        ...
        private void MultiplyAtAv(double[] v, double[] tmp, double[] AtAv)
        {
            ...
            Console.WriteLine("signalandwait begin");
            barrier.SignalAndWait();
            Console.WriteLine("signalandwait end");
